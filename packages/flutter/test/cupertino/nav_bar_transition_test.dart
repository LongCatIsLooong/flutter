...
void main() {
  testWidgets('Bottom middle moves between middle and back label', (WidgetTester tester) async {
    ...
    expect(
      ...
      Offset(
        TextPainter.shouldDisableRoundingHack ? 342.547737105096302912 : 342.33420100808144,
        13.5,
      ),
    );
    expect(
  ...
  testWidgets('Bottom middle moves between middle and back label RTL', (WidgetTester tester) async {
    ...
    expect(
      tester.getTopLeft(flying(tester, find.text('Page 1')).first),
      Offset(
        TextPainter.shouldDisableRoundingHack ? 357.912261979376353338 : 357.66579899191856,
        13.5,
      ),
    );
    expect(
  ...
  testWidgets('First appearance of back chevron fades in from the right', (WidgetTester tester) async {
    ...
    expect(tester.getTopLeft(backChevron), Offset(
      TextPainter.shouldDisableRoundingHack ? 87.2460581221158690823 : 88.04496401548386,
      7.0,
    ));
    ...
    expect(tester.getTopLeft(backChevron), Offset(
      TextPainter.shouldDisableRoundingHack ? 30.8718595298545324113 : 31.055883467197418,
      7.0,
    ));
  });
  ...
  testWidgets('First appearance of back chevron fades in from the left in RTL', (WidgetTester tester) async {
    ...
    expect(
      ...
      Offset(
        TextPainter.shouldDisableRoundingHack ? 687.163941725296126606 : 685.9550359845161,
        7.0,
      ),
    );
    ...
    expect(
      tester.getTopRight(backChevron),
      Offset(
        TextPainter.shouldDisableRoundingHack ? 743.538140317557690651 : 742.9441165328026,
        7.0,
      ),
    );
  });
  ...
  testWidgets('Bottom trailing fades in place', (WidgetTester tester) async {
    ...
    expect(
      tester.getTopLeft(flying(tester, find.text('custom'))),
      Offset(
        TextPainter.shouldDisableRoundingHack ? 684.459999084472656250 : 684.0,
        13.5,
      ),
    );
  ...
  testWidgets('Bottom back label fades and slides to the left', (WidgetTester tester) async {
    ...
    expect(
      ...
      Offset(
        TextPainter.shouldDisableRoundingHack ? 41.3003370761871337891 : 41.71033692359924,
        13.5,
      ),
    );
    ...
    expect(
      tester.getTopLeft(flying(tester, find.text('Page 1'))),
      Offset(
        TextPainter.shouldDisableRoundingHack ? -258.642192125320434570 : -258.2321922779083,
        13.5,
      ),
    );
  });
  ...
  testWidgets('Bottom back label fades and slides to the right in RTL', (WidgetTester tester) async {
    ...
    expect(
      ...
      Offset(
        TextPainter.shouldDisableRoundingHack ? 758.699662923812866211 : 758.2896630764008,
        13.5,
      ),
    );
    ...
    expect(
      ...
      Offset(
        TextPainter.shouldDisableRoundingHack ? 1058.64219212532043457 : 1058.2321922779083,
        13.5,
      ),
    );
  });
  ...
  testWidgets('Bottom large title moves to top back label', (WidgetTester tester) async {
    ...
    expect(
      tester.getTopLeft(flying(tester, find.text('Page 1')).first),
      Offset(
        TextPainter.shouldDisableRoundingHack ? 16.9155227761479522997 : 16.926069676876068,
        52.73951627314091,
      ),
    );
    expect(
    ...
    expect(
      tester.getTopLeft(flying(tester, find.text('Page 1')).first),
      Offset(
        TextPainter.shouldDisableRoundingHack ? 43.6029094262710827934 : 43.92089730501175,
        22.49655644595623,
      ),
    );
    expect(
  ...
  testWidgets('Top middle fades in and slides in from the right', (WidgetTester tester) async {
    ...
    expect(
      ...
      Offset(
        TextPainter.shouldDisableRoundingHack ? 739.940336465835571289 : 739.7103369235992,
        13.5,
      ),
    );
    ...
    expect(
      tester.getTopLeft(flying(tester, find.text('Page 2'))),
      Offset(
        TextPainter.shouldDisableRoundingHack ? 504.880443334579467773 : 504.65044379234314,
        13.5,
      ),
    );
  });
  ...
  testWidgets('Top middle fades in and slides in from the left in RTL', (WidgetTester tester) async {
    ...
    expect(
      ...
      Offset(
        TextPainter.shouldDisableRoundingHack ? 60.0596635341644287109 : 60.28966307640076,
        13.5,
      ),
    );
    ...
    expect(
      tester.getTopRight(flying(tester, find.text('Page 2'))),
      Offset(
        TextPainter.shouldDisableRoundingHack ? 295.119556665420532227 : 295.34955620765686,
        13.5,
      ),
    );
  });
  ...
  testWidgets('Back swipe gesture transitions', (WidgetTester tester) async {
    ...
    expect(
      tester.getTopLeft(flying(tester, find.text('Page 2'))),
      Offset(
        TextPainter.shouldDisableRoundingHack ? 353.810205429792404175 : 353.5802058875561,
        13.5,
      ),
    );
    ...
    expect(
      tester.getTopLeft(flying(tester, find.text('Page 2'))),
      Offset(
        TextPainter.shouldDisableRoundingHack ? 655.435583114624023438 : 655.2055835723877,
        13.5,
      ),
    );
    await tester.pump(const Duration(milliseconds: 50));
    expect(
      tester.getTopLeft(flying(tester, find.text('Page 2'))),
      Offset(
        TextPainter.shouldDisableRoundingHack ? 749.863556146621704102 : 749.6335566043854,
        13.5,
      ),
    );
  ...
  testWidgets('Back swipe gesture cancels properly with transition', (WidgetTester tester) async {
    ...
    expect(
      tester.getTopLeft(flying(tester, find.text('Page 2'))),
      Offset(
        TextPainter.shouldDisableRoundingHack ? 350.231143206357955933 : 350.0011436641216,
        13.5,
      ),
    );
