        ...
        switch (materialType) {
          case MaterialType.material2:
            ...
            expect(tester.getBottomRight(find.text(selectTimeString)), equals(
              TextPainter.shouldDisableRoundingHack ? const Offset(280.5, 165) : const Offset(281, 165),
            ));
        ...
        switch (materialType) {
          case MaterialType.material2:
            expect(tester.getTopLeft(find.text(selectTimeString)), equals(
              TextPainter.shouldDisableRoundingHack ? const Offset(519.5, 155) : const Offset(519, 155),
            ));
